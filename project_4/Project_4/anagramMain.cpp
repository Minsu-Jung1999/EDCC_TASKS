...
int main() {
    ...
    // TODO: uncomment out the next line once you have written your constructor
    Anagrams solver(dictionary);
    bool done = false;
    while (!done) {
        cout << endl;
        ...
        if (phrase.length() == 0) {
            ...
            // TODO: uncomment out the next two lines once you have written getWords
